...
> **Snapshot notice:** The labs on `main` were updated, tested, and cleaned up in [#64](https://github.com/Azure-Samples/open-source-labs/pull/64). The collection as it stood before that is preserved on the [`2026-05-01`](https://github.com/Azure-Samples/open-source-labs/tree/2026-05-01) branch. See [Lab snapshots](docs/snapshot.md) for what changed, and for how to deploy a lab from a snapshot rather than from `main`.
